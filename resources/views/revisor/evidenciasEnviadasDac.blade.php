...
<nav aria-label="breadcrumbpers">
  <ol class="breadcrumbpers">
    ...
    <li class="breadcrumbpers-item active" aria-current="page">Evidencias enviadas a DAC</li>
  </ol>
</nav>
...
<nav aria-label="">
  <ol class="breadcrumbpers2">
    ...
    <li class="breadcrumbpers2-item"><a class="white-text2" href="#">Home</a></li>
    <li class="breadcrumbpers2-item"><a class="white-text2" href="#">Library</a></li>
    <li class="breadcrumbpers2-item active" aria-current="page">Evidencias enviadas a DAC</li>
    <li class="breadcrumbpers2-item active" aria-current="page">Evidencias enviadas a DAC</li>
  </ol>
</nav>
...
<ul id="breadcrumbs-one">
    ...
    <li><a href="" class="current">Evidencias enviadas a DAC</a></li>
</ul>
    	...
    	<div class="col-md-8 paddingesp ">
			<div id="pricing-table" class="clear row">
					...
					<div class="plan">
				        ...
				        <ul>	
				        	<li class="icon-12"><b>Titulo</b><br>{{$evidencia->titulo}}</li>	
				            <li><b>Run</b><br>{{$evidencia->run}}</li>
				            <li class="icon-12"><b>Fecha</b><br> {{$evidencia->fecha_realizacion}}</li>
